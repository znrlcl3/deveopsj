...
@Getter
@Setter
public class RecurringSavingsRequest {

    private Long id;

    @NotBlank(message = "정기 납입 이름을 입력해 주세요.")
    ...
    @NotNull(message = "납입일을 입력해 주세요.")
    @Min(value = 1, message = "납입일은 1일부터 31일까지 입력해 주세요.")
    @Max(value = 31, message = "납입일은 1일부터 31일까지 입력해 주세요.")
